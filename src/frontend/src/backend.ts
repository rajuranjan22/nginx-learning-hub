...
export class Backend implements backendInterface {
    ...
    async getLessonStatus(arg0: SessionId, arg1: LessonId): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.getLessonStatus(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getProgressPercentage(arg0: SessionId): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async markLesson(arg0: SessionId, arg1: LessonId, arg2: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markLesson(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
